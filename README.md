...
– Texture mapping & performance optimizations  
...
| **webserv**           | `100/100`   | HTTP server, concurrency, parsing          | 🔴 High       |
...
| **so_long**           | `115/100`   | 2D game engine, graphics                   | 🟡 Medium     |
| **minitalk**          | `116/100`   | UNIX signals, IPC                          | 🟡 Medium     |
| **ft_printf**         | `100/100`   | Variadic functions, format handling        | 🟢 Basic      |
...
📍 **Ovar, Portugal** 🇵🇹 | **Status:** 42 Porto Graduate | **Open to:** HealthTech & Automotive roles  
🌟 **Specialization:** Safety-critical systems | **Strength:** Resilience & precision
